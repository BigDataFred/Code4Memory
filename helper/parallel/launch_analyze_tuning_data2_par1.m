...
params.p2Nlxdata = ['/home/rouxf/in/',params.pID,'/'];%path 2 Nlx data
params.savepath = ['/home/rouxf/out/',params.pID,'/'];%path for saving
...
[params.timestamps, ~, params.sampleFreq, ~, dataSamples , headerInfo] = Nlx2MatCSC_v3([params.p2Nlxdata,params.CSClabels{1}], FieldSelection, ExtractHeader, ExtractMode, []);
