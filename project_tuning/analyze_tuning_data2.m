function [data,readme] = analyze_tuning_data2(params)
...
try
    ...
    [par]                               = set_parameters_Bham(params.hdr2.Fs,params.spike_tresh);
...
%             params_ts.extractionThreshold = params.spike_tresh;
